...
const reportColumns = {
  work: [
    ...
    { header: "Checked Description", keys: ["Checked Description", "checkedDescription"] },
    ...
    { header: "Recommended Description", keys: ["Recommended Description", "recommendedDescription"] },
    ...
    { header: "Approval Description", keys: ["Approval Description", "approvalDescription"] },
